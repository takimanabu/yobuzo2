...
<html lang="ja" style="margin-top: 0px !important;">
  <head>
    ...
    <title>お知らせ一覧​|介護タクシー呼ぶなら「よぶぞー」</title>
    ...
    <script>
      $(window).on('load', function () {
        ...
        var pageNav = document.querySelector('.wp-pagenavi');
        var prevLink = document.querySelector('.previouspostslink');
        var nextLink = document.querySelector('.nextpostslink');
        if (prevLink === null){
          let prevBlock = document.createElement('div');
          prevBlock.classList.add('prev-block');
          pageNav.prepend(prevBlock);
        }
        if (nextLink === null){
          let nextBlock = document.createElement('div');
          nextBlock.classList.add('next-block');
          pageNav.append(nextBlock);
        }
      });
    </script>
    <!-- Google Tag Manager -->
